...
String supla_webpage_ping(int save) {
  String content = "";
  ...
  content += "<br>";
  content += "<center>";
  content += "<form method='post' action='save_ping'>";
  content += "<div class='w'>";
  content += "<h3>Konfiguracja Ping</h3>";
  content += "<i><input name='ping_ip_pc' value='" + String(read_supla_ping_ip().c_str()) + "' maxlength='15' placeholder='000.000.000.000'";
  content += "><label>Adres IP</label></i>";
  content += "<i><input name='ping_time_pc' ";
  content += "value='" + String(read_supla_ping_time().c_str()) + "' maxlength='3'  placeholder='000'>";   
  content += "<label>Czasookres</label></i>";
  content += "</div>";
  content += "<br>";  
  content += "<button type='submit'>Zapisz dane</button></form>";
  content += "<br><br>";
...
String supla_webpage_wakeup(int save) {
  String content = "";
  ...
  content += "<br>";
  content += "<center>";
  content += "<form method='post' action='save_awankened'>";
  content += "<div class='w'>";
  content += "<h3>Konfiguracja WoL</h3>";
  content += "<i><input name='awakened_ip_pc' value='" + String(read_supla_awakened_ip().c_str()) + "' maxlength='15' placeholder='000.000.000.000'";
  content += "><label>Adres IP</label></i>";
  content += "<i><input name='awakened_mac_pc' ";
  content += "value='" + String(read_supla_awakened_mac().c_str()) + "' maxlength='17'  placeholder='00-00-00-00-00-00'>";   
  content += "<label>Adres MAC</label></i>";
  content += "</div>";
  content += "<br>";  
  content += "<button type='submit'>Zapisz dane</button></form>";
  content += "<br><br>";
...
*/
  ...
  content += "<a href='/WakeUp'><button>Konfiguracja WoL</button></a>";
  content += "<br><br>";  
  content += "<a href='/Ping'><button>Konfiguracja Ping</button></a>";
  content += "<br><br>";  
